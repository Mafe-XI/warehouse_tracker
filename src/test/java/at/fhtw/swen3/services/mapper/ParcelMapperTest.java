...
public class ParcelMapperTest {
    ...
    void parcelEntityToNewParcelInfoDto() {
        ParcelEntity parcel = new ParcelEntity("123456789", 12.0f, sender, recipient, at.fhtw.swen3.services.dto.TrackingInformation.StateEnum.INTRANSPORT, visitedHops, futureHops);

        NewParcelInfo newParcelInfoDto = ParcelMapper.INSTANCE.parcelEntityToNewParcelInfoDto(parcel);

        assertEquals( "123456789", newParcelInfoDto.getTrackingId());
    }
